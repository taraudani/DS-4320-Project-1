...
<table border="1" class="dataframe">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-bfaf1c8f-689f-473a-b85d-3f978b146397 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-bfaf1c8f-689f-473a-b85d-3f978b146397');
        const dataTable =
  ...
  <div id="id_8591679e-c74f-40df-a579-4b399a996cbd">
    <style>
      .colab-df-generate {
        background-color: #E8F0FE;
        border: none;
  ...
  <svg xmlns="http://www.w3.org/2000/svg" height="24px"viewBox="0 0 24 24"
    ...
    <script>
      (() => {
      const buttonEl =
        document.querySelector('#id_8591679e-c74f-40df-a579-4b399a996cbd button.colab-df-generate');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-8807bbf8-95e7-4664-86d9-78feaab66bc7')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-8807bbf8-95e7-4664-86d9-78feaab66bc7 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-8807bbf8-95e7-4664-86d9-78feaab66bc7');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
  ...
  <div id="id_f2363336-66e5-4f2c-81dc-bc0a0d79e368">
    <style>
      .colab-df-generate {
        background-color: #E8F0FE;
        border: none;
  ...
  <svg xmlns="http://www.w3.org/2000/svg" height="24px"viewBox="0 0 24 24"
    ...
    <script>
      (() => {
      const buttonEl =
        document.querySelector('#id_f2363336-66e5-4f2c-81dc-bc0a0d79e368 button.colab-df-generate');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
...
<table border="1" class="dataframe">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-e86fb242-a35f-4667-aadd-c73037af8563 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-e86fb242-a35f-4667-aadd-c73037af8563');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
  ...
  <div id="id_952ad640-f01f-4c11-951a-f372c4c19b7a">
    <style>
      .colab-df-generate {
        background-color: #E8F0FE;
        border: none;
    ...
    <button class="colab-df-generate" onclick="generateWithVariable('q3')"
            title="Generate code using this dataframe."
            style="display:none;">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" height="24px"viewBox="0 0 24 24"
    ...
    <script>
      (() => {
      const buttonEl =
        document.querySelector('#id_952ad640-f01f-4c11-951a-f372c4c19b7a button.colab-df-generate');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      buttonEl.onclick = () => {
        google.colab.notebook.generateWithVariable('q3');
      }
      })();
    </script>
  </div>
...
<table border="1" class="dataframe">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-38f3d92b-fa8a-4b22-a0fc-7d26e38594ce button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-38f3d92b-fa8a-4b22-a0fc-7d26e38594ce');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
  ...
  <div id="id_9b8e6502-1547-4eec-a483-0b64caf58f92">
    <style>
      .colab-df-generate {
        background-color: #E8F0FE;
        border: none;
    ...
    <button class="colab-df-generate" onclick="generateWithVariable('scenario_df')"
            title="Generate code using this dataframe."
            style="display:none;">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" height="24px"viewBox="0 0 24 24"
    ...
    <script>
      (() => {
      const buttonEl =
        document.querySelector('#id_9b8e6502-1547-4eec-a483-0b64caf58f92 button.colab-df-generate');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      buttonEl.onclick = () => {
        google.colab.notebook.generateWithVariable('scenario_df');
      }
      })();
    </script>
  </div>
